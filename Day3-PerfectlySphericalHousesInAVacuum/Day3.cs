 ...
 * Code for Advent of Code 2015, Day 3
...
// Dictionary used as a grid to keep track of how many gifts
// each house gets. 
var dict = new Dictionary<(int x,int y), int>();


// Starting location gets a gift
dict.Add((0, 0), 1);

// Problem input, too long for debugger
...
// For each character in the input, santa moves to a different location
// In part 2 of the problem, Santa and Robo-Santa take turns moving, and therefore need to be kept track separately
// As well as increasing the index by two rather than one
